...
class Tootja extends Thread {
   ...
   public void run() {
      System.out.println ("jpoial.Tootja alustas... ");
      try {
         for (int i = 0; i < 9; i++) {
      ...
      System.out.println ("jpoial.Tootja lopetas");
   }
...
class Tarbija extends Thread {
   ...
   public void run() {
      System.out.println ("jpoial.Tarbija alustas... ");
      try {
         int i = 0;
         int r = -1;
         while ((r = voog.read()) != -1) {
      ...
      System.out.println ("jpoial.Tarbija lopetas");
   }
