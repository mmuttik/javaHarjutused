...
/**
 * Fail other.Graafid.java
 * @author Jaanus Poial
 * @version 0.2 kevad 99
 */

//====================================================================
// Na"ide ahelatest ja graafist.        other.Liides ja tuletatud klassid.
//--------------------------------------------------------------------
// other.Graaf on kujutatud ku"lgnevusstruktuurina -- tippude ahel,
...
//==========================================================
// other.Liides graafi, tippude ja kaarte jaoks
//==========================================================
...
//================================================================
// other.Graaf on tippude ahel, mis realiseerib other.AbstrGraaf liidese
//================================================================
...
class Graaf extends Element implements AbstrGraaf {
   ...
   public String toString () {
      String abi = "other.Graaf: " + votaNimi() + "\n";
      Tipp t = votaEsimene();
      while (t != null) {
         abi += t.votaNimi() + " --> ";
...
//========================================================================
// other.Tipp sisaldab va"ljuvate kaarte ahela ja realiseerib other.AbstrTipp liidese
//========================================================================
...
//================================================================
// other.Kaar sisaldab infot tipu kohta, millesse ta suubub ja
// realiseerib other.AbstrKaar liidese
//================================================================
